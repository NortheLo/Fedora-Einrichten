...
if [ "$EUID" == 0 ]
	...
	dnf install gparted code cargo gfortran neovim gnome-tweak-tool gnome-extensions-app kernel-devel gcc g++ alacarte virt-manager kicad kicad-packages3d -y 
