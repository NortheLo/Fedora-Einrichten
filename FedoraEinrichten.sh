...
if [ "$EUID" == 0 ]
	...
	dnf install gparted code gfortran neovim gnome-tweak-tool gnome-extensions-app kernel-devel gcc g++ cmake alacarte virt-manager kicad kicad-packages3d lm_sensors cargo clangd octave ulauncher htop -y 
