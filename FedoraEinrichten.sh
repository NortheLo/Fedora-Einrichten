...
if [ "$EUID" == 0 ]
	...
	dnf install gparted code gfortran opam dune wireguard-tools neovim gnome-tweak-tool gnome-extensions-app kernel-devel gcc g++ cmake alacarte virt-manager kicad kicad-packages3d lm_sensors cargo rustup clangd octave ulauncher htop -y 
